...
export const AIResearcherMode: React.FC<AIResearcherModeProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col p-3 sm:p-4 bg-slate-50 text-slate-900 max-w-lg md:max-w-3xl lg:max-w-4xl mx-auto w-full pb-32">
      ...
      {/* Modal oficial de anúncio premiado (Rewarded Ad) para desbloquear pesquisa */}
      <RequiredAdsModal
        isOpen={isRequiredAdsOpen}
        featureTitle="Pesquisa"
        description="Assista a um anúncio para liberar esta pesquisa completa."
        requiredCount={1}
        onSuccess={() => handleSearch(pendingQuery)}
