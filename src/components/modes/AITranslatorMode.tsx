...
export const AITranslatorMode: React.FC<AITranslatorModeProps> = ({
  ...
  // Request Translation via Ad Consent
  ...
  return (
    <div className="min-h-full flex flex-col bg-slate-50 text-slate-900 pb-20">
      ...
      {/* Modal oficial de anúncio premiado (Rewarded Ad) para desbloquear tradução */}
      <RequiredAdsModal
        isOpen={isRequiredAdsOpen}
        featureTitle="Tradução"
        description="Assista a um anúncio para liberar esta tradução pedagógica completa."
        requiredCount={1}
        onSuccess={handleTranslate}
