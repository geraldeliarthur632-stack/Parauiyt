...
export const AIExplainerMode: React.FC<AIExplainerModeProps> = ({
  ...
  const [isRequiredAdsOpen, setIsRequiredAdsOpen] = useState(false);
  ...
  return (
    <div className="flex-1 flex flex-col p-3 sm:p-4 bg-slate-50 text-slate-900 max-w-lg md:max-w-3xl lg:max-w-4xl mx-auto w-full pb-32">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-200">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-base sm:text-lg font-black text-slate-900 leading-tight">Explicador IA</h1>
          ...
          <div className="p-4 sm:p-5 rounded-3xl bg-gradient-to-r from-purple-50 via-indigo-50 to-white border border-purple-200 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] text-slate-500 font-medium">Explicação Completa IA</span>
              </div>
      ...
      {/* Modal oficial de anúncio premiado (Rewarded Ad) para desbloquear explicação */}
      <RequiredAdsModal
        isOpen={isRequiredAdsOpen}
        featureTitle="Explicação"
        description="Assista a um anúncio para liberar esta explicação."
        requiredCount={1}
        onSuccess={handleExplain}
